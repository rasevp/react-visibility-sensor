          ...
          function e(t) {
            ...
            return (
              ...
              m(
                ...
                "getContainer",
                function() {
                  return u.props.containment || window;
                }
              ),
              m(b(u), "addEventListener", function(t, e, o, n) {
                var r;
                u.debounceCheck || (u.debounceCheck = {});
                function i() {
                  (r = null), u.check();
                }
                var a = {
                ...
                t.addEventListener(e, a.fn), (u.debounceCheck[e] = a);
              }),
              m(b(u), "startWatching", function() {
                u.debounceCheck ||
                  u.interval ||
                  (u.props.intervalCheck &&
                    (u.interval = setInterval(u.check, u.props.intervalDelay)),
                  u.props.scrollCheck &&
                    u.addEventListener(
                      u.getContainer(),
                      "scroll",
                      u.props.scrollDelay,
                      u.props.scrollThrottle
                    ),
                  u.props.resizeCheck &&
                    u.addEventListener(
                      window,
                      "resize",
                      u.props.resizeDelay,
                      u.props.resizeThrottle
                    ),
                  u.props.delayedCall || u.check());
              }),
              m(b(u), "stopWatching", function() {
                if (u.debounceCheck)
                  for (var t in u.debounceCheck)
                    if (u.debounceCheck.hasOwnProperty(t)) {
                      var e = u.debounceCheck[t];
                      clearTimeout(e.getLastTimeout()),
                        e.target.removeEventListener(t, e.fn),
                        (u.debounceCheck[t] = null);
                    }
                (u.debounceCheck = null),
                  u.interval && (u.interval = clearInterval(u.interval));
              }),
              m(b(u), "check", function() {
                var t,
                  e,
                  o = u.node;
                if (!o) return u.state;
                if (
                  ...
                  })(u.roundRectDown(o.getBoundingClientRect()))),
                  u.props.containment)
                ) {
                  var n = u.props.containment.getBoundingClientRect();
                  e = {
                    top: n.top,
                    left: n.left,
                    bottom: n.bottom,
                ...
                if (a && u.props.partialVisibility) {
                  var c =
                    t.top <= e.bottom &&
                    t.bottom >= e.top &&
                    t.left <= e.right &&
                    t.right >= e.left;
                  "string" == typeof u.props.partialVisibility &&
                    (c = i[u.props.partialVisibility]),
                    (l = u.props.minTopValue
                      ? c && t.top <= e.bottom - u.props.minTopValue
                      : c);
                }
                ...
                return (
                  u.state.isVisible !== l &&
                    ((s = { isVisible: l, visibilityRect: i }),
                    u.setState(s),
                    u.props.onChange && u.props.onChange(l)),
                  u.props.onCheck && u.props.onCheck(l),
                  s
                );
              }),
              (u.state = { isVisible: null, visibilityRect: {} }),
              u
            );
          }
          return (
